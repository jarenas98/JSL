...
function dibujarGraficarTopProcesosCPU() {
    ...
    var chart = new google.visualization.BarChart(document.getElementById('top-procesos-cpu'));
...
function dibujarGraficarTopProcesosRAM() {
    ...
    var chart = new google.visualization.BarChart(document.getElementById('top-procesos-ram'));
