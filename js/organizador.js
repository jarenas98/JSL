...
var datos =
  //ZonaDeCambio+
  {
    ...
    todosLosUsuarios: {
      "0": { nombre: "root", nombreCompleto: "root" },
      "1": { nombre: "daemon", nombreCompleto: "daemon" },
      "2": { nombre: "bin", nombreCompleto: "bin" },
      "3": { nombre: "sys", nombreCompleto: "sys" },
      "4": { nombre: "sync", nombreCompleto: "sync" },
      "5": { nombre: "games", nombreCompleto: "games" },
      "6": { nombre: "man", nombreCompleto: "man" },
      "7": { nombre: "lp", nombreCompleto: "lp" },
      "8": { nombre: "mail", nombreCompleto: "mail" },
      "9": { nombre: "news", nombreCompleto: "news" },
      "10": { nombre: "uucp", nombreCompleto: "uucp" },
      "13": { nombre: "proxy", nombreCompleto: "proxy" },
      "33": { nombre: "www-data", nombreCompleto: "www-data" },
      "34": { nombre: "backup", nombreCompleto: "backup" },
      "38": { nombre: "list", nombreCompleto: "Mailing List Manager" },
      "39": { nombre: "irc", nombreCompleto: "ircd" },
      "41": {
        nombre: "gnats",
        nombreCompleto: "Gnats Bug-Reporting System (admin)",
      },
      "65534": { nombre: "nobody", nombreCompleto: "nobody" },
      "100": {
        nombre: "systemd-network",
        nombreCompleto: "systemd Network Management",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "101": {
        ...
        nombreCompleto: "systemd Resolver",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "102": { nombre: "syslog", nombreCompleto: "" },
      "103": { nombre: "messagebus", nombreCompleto: "" },
      "104": { nombre: "_apt", nombreCompleto: "" },
      "105": { nombre: "uuidd", nombreCompleto: "" },
      "106": {
        nombre: "cups-pk-helper",
        nombreCompleto: "user for cups-pk-helper service",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "107": {
        nombre: "kernoops",
        nombreCompleto: "Kernel Oops Tracking Daemon",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "108": {
        nombre: "rtkit",
        nombreCompleto: "RealtimeKit",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "109": {
        nombre: "avahi-autoipd",
        nombreCompleto: "Avahi autoip daemon",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      ...
      "111": {
        ...
        nombreCompleto: "systemd core dump processing",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "112": { nombre: "lightdm", nombreCompleto: "Light Display Manager" },
      "113": {
        nombre: "dnsmasq",
        nombreCompleto: "dnsmasq",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "114": { nombre: "saned", nombreCompleto: "" },
      "115": {
        nombre: "nm-openvpn",
        nombreCompleto: "NetworkManager OpenVPN",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "116": {
        nombre: "avahi",
        nombreCompleto: "Avahi mDNS daemon",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "117": {
        nombre: "colord",
        nombreCompleto: "colord colour management daemon",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "118": {
        nombre: "speech-dispatcher",
        nombreCompleto: "Speech Dispatcher",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "119": {
        nombre: "pulse",
        nombreCompleto: "PulseAudio daemon",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "120": {
        nombre: "hplip",
        nombreCompleto: "HPLIP system user",
        noHab: "",
        telOficina: "",
        telCasa: "",
      },
      "121": { nombre: "geoclue", nombreCompleto: "" },
      "1000": {
        nombre: "montes",
        nombreCompleto: "montes",
        noHab: "",
      ...
      "999": { nombre: "vboxadd", nombreCompleto: "" },
      "1001": { nombre: "sebas", nombreCompleto: "" },
      "122": { nombre: "sshd", nombreCompleto: "" },
    },
    cantidadUsuariosReales: 1,
    cantidadTotalUsuarios: 44,
    ipEquipo: "192.168.0.127",
    mac: "08:00:27:ee:75:8a",
    totalRAM: 4651,
    totalSwap: 969,
    particiones: { "/dev/sda1": 20029 },
    cpuCores: 4,
    cpuFrec: 3591.686,
    topProcesosCPU: {
      "1561": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "cinnamon",
        "Porcentaje de uso de CPU": "26.0",
      },
      "2372": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "/usr/share/code/code",
        "Porcentaje de uso de CPU": "3.7",
      },
      "1824": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "/usr/share/code/code",
        "Porcentaje de uso de CPU": "3.6",
      },
      "3684": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "xreader",
        "Porcentaje de uso de CPU": "3.0",
      },
      "2748": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "xreader",
        "Porcentaje de uso de CPU": "2.4",
      },
    },
    topProcesosRAM: {
      "1192": {
        usuarioPropietario: "root",
        "Nombre del proceso": "/usr/lib/xorg/Xorg",
        "Porcentaje de uso de RAM": "7.2",
      },
      "1561": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "cinnamon",
        "Porcentaje de uso de RAM": "6.6",
      },
      "1824": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "/usr/share/code/code",
        "Porcentaje de uso de RAM": "6.4",
      },
      "2372": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "/usr/share/code/code",
        "Porcentaje de uso de RAM": "4.1",
      },
      "2891": {
        usuarioPropietario: "montes",
        "Nombre del proceso": "xreader",
        "Porcentaje de uso de RAM": "3.5",
      },
    },
    usoDeCPU: 11.2,
    usoDeRAM: 48.6,
    usoDeSWAP: 0.0,
    usoDeAlmacenamientoTotal: 43.3,
    usoDeParticiones: { "/dev/sda1": 43.3 },
    totalAlmacenamiento: 20.0,
    totalParticiones: 1,
    usoDeShells: [
      ["/usr/sbin/nologin", "36"],
      ["/bin/sync", "1"],
    ...
    usuariosConectados: [["montes", "tty7", "11:27"]],
    fecha: "Reporte generado el día 31 del mes 05 del año 2020, a las 12:09:28",
  };
